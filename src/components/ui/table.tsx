...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("border-t border-border bg-background/50 font-medium", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border transition hover:bg-background/50 data-[state=selected]:bg-background",
      className
    )}
    {...props}
  />
